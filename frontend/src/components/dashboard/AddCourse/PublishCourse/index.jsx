...
export default function PublishCourse() {
  ...
  const handleCoursePublish = async () => {
    ...
    setLoading(true)
    const response = await axios.post(`${import.meta.env.VITE_SERVER_URL}course/editCourse`, formData, { withCredentials: true })
  ...
  return (
    <div className="rounded-md bg-richblack-800 p-6 bg-white shadow-sm">
