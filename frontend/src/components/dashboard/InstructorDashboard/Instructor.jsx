	...
	return (
		<div>
			<div className="space-y-2">
				<h1 className="text-2xl font-bold text-black-5">
					Hi {user?.firstName} 👋
				</h1>
				<p className="font-medium text-black-200">
				...
				<div>
					...
					<div className="rounded-md md:p-6">
						...
						<div className="flex items-center justify-between">
							<p className="text-lg font-bold text-black-5">
								Your Courses
							</p>
								...
								>
									...
									<div className="mt-3 w-full">
										...
										<div className="mt-1 flex items-center space-x-2">
											<p className="text-xs font-medium text-black-300">
