...
function ReviewSlider() {
	...
	return (
		<div className="w-full bg-[--color-background] py-12 mb-8">
			<div className="mx-auto max-w-6xl">
				<h2 className="text-3xl md:text-5xl font-bold text-center mb-12 mt-12 font-orbitron text-gray-500">
					Student{" "}
								...
								<div className="group flex min-h-50 flex-col justify-center gap-2 rounded-2xl bg-white p-4 shadow-md transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
									...
									<div className="flex items-center gap-1 mt-2">
										{[1, 2, 3, 4, 5].map((star) => (
											<div>
												{
													star <= review.rating ? <FaStar className="text-yellow-500"/>: <FaRegStar/>
												}
									...
									<div>
										<p className="text-xs mt-2 text-gray-400">Post: {new Date(review.createdAt).toLocaleDateString()}</p>
									</div>
